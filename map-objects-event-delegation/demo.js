...
function testDelegation(map) {
  ...
  var brandenburgerTorMarker = new H.map.Marker(
    new H.geo.Point(52.516237, 13.377686)
  );

  // Fernsehturm in Berlin, Germany
  var fernsehturmMarker = new H.map.Marker(
    new H.geo.Point(52.520816, 13.409417)
  );
  ...
  var polygon = new H.map.Polygon(
    new H.geo.Polygon(
      new H.geo.LineString([
        52.51998, 13.40529, 0, 52.52395, 13.4125, 0, 52.52197, 13.4159, 0,
        52.5186, 13.40718, 0,
      ])
    ),
    {
  ...
  var polyline = new H.map.Polyline(
    new H.geo.LineString([
      52.52149, 13.387983, 0, 52.517156, 13.38882, 0, 52.51696, 13.38573, 0,
      52.51551, 13.386009, 0, 52.515132, 13.381481, 0, 52.516333, 13.380806, 0,
    ]),
    {
      style: {
