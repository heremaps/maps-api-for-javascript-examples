...
function testObjectsEvents(map, logEvent) {
  ...
  var rect = new H.map.Rect(new H.geo.Rect(51.5072, 0, 48.8567, 2.3508), {
    style: style,
  });

  // Create a circle map object
  var circle = new H.map.Circle(
    new H.geo.Point(52.3667, 4.9), //center
  ...
  var polyline = new H.map.Polyline(
    new H.geo.LineString([
      52.5167, 13.3833, 0, 50.0833, 14.4167, 0, 52.2333, 21.0167, 0,
    ]),
    { style: style }
  );
  ...
  var polygon = new H.map.Polygon(
    new H.geo.Polygon(
      new H.geo.LineString([
        45.4667, 9.1833, 0, 48.1333, 11.566, 0, 50.08, 8.24, 0
      ])
    ),
    { style: style }
  );
