...
function landmarkGeocode(platform) {
  ...
  geocoder.discover(landmarkGeocodingParameters, onSuccess, onError);
}
...
function addLocationsToPanel(locations) {
  ...
  for (i = 0; i < locations.length; i += 1) {
    ...
    content +=
      "<strong>houseNumber:</strong> " + location.address.houseNumber + "<br/>";
    content += "<strong>street:</strong> " + location.address.label + "<br/>";
    content +=
      "<strong>district:</strong> " + location.address.district + "<br/>";
    content += "<strong>city:</strong> " + location.address.city + "<br/>";
    content +=
      "<strong>postalCode:</strong> " + location.address.postalCode + "<br/>";
    content += "<strong>county:</strong> " + location.address.county + "<br/>";
    content +=
      "<strong>country:</strong> " + location.address.countryName + "<br/>";
    content +=
